                    ...
                    <div class="col">
                        ...
                        <form action="?id=admin" method="POST" enctype="multipart/form-data">
                            <div class="col input-group mb">
                                ...
                                <button type="submit" name="tipe" value="Backup" class="btn btn-primary">Cadangkan</button>
                            </div>
                        </form>
                    </div>
                    <div class="col">
                        ...
                        <form action="?id=admin" method="POST" enctype="multipart/form-data">
                            <div class="col input-group mb">
                                ...
                                <button type="submit" name="tipe" value="Restore" class="btn btn-primary">Memulihkan</button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="col">
                        <table class="table">
                            <thead class="bg-dark text-white text-center">
                                <tr><td>table pada Upicts</td><td>jumlah</td></tr>
                            </thead>
                            <tbody>
                                <?php 
